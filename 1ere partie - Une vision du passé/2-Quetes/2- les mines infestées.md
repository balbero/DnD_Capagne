...
pnj :
-   _Fanatique de Nerull_ (FP 1/2) *5
...
Arbalette -> 1d8 (19/20x2)

-   _Garde de la caravane_ (Epée + bouclier )*2
...
Att -> +2  
Epée courte -> 1d6 (19-20x2)

-   _Garde de la caravane_ (Lance ) *2
...
-   _Garde de la caravane_ (arc court composite)*2
...
L'odeur est insoutenable (jet de vigueur **DD15**), des mouches volent par centaines. Les cadavres des mineurs sont là à même le sol. Certains éventrés, d'autre les membres semblent avoir été arrachés. Mais tous ont le visage horrifié.

-   Si les aventuriers ont aidé la caravane :
    -   L'un des gardes restant se fera attaquer, 3 cadavres se relèvent.
-   Sinon
    -   3 cadavres se relèvent après leur passage (75%) ou durant leur fouille.

-   _Zombi Mineur_ (FP 1/2) *3
...
Reduction dégât : -5dmg/tranchant
...
Lors de leur entré dans la mine, le nain sent un danger :

-   Piège fosse camouflée **[DD24 fouille] [DD20 Désamorçage/Sabotage]**: 1d6 de chute (jet de reflexe / 2 les dmg  **DD15**)
...
-   Maitrise des cordes [**DD20**] : L'assemblage est complexe. On peut cependant repérer que l'une des cordes est très usée, à la limite de la rupture.

_L'utilisation du levier 3, fera remonter le plateau mais la corde lâchera en cours de route faisant tomber le plateau qui se fracassera au sol._

La salle est un croisement.

**A l'ouest**

A l'ouest les reste d'une salle de repas.  
3 tables et 30 sièges sont disposés.  
Les madriers contiennent des torchères toutes éteintes.  
Des cadavres sont au sol, d'autre adossé au mur et certains sur les tables.  
A l'une des tables, est penché une forme humanoïde qui semble manger bruyamment.  

_C'est une goule, les goules parlent. Les entendants, elle leur répondra "Manger!" et continuera de manger le cadavre devant-elle jusqu'à ce que les aventuriers n'approche que trop près._
...
Attaque à outrance:
-  morsure 1d6 +1 (paralysie)
-  griffe 1d3 +1 (paralysie) *2
- Paralysie: Vigueur DD12 ==> paralysé pendant 1d4 tour (jet de CHA  pour se mouvoir ==> DD13)
- Fièvre de la goule: sur morsure. Vigueur DD12 ==> Affaiblissement temporaire: 1d3 dex, 1d3 const (incubation 1jour, CHA/DD13)
...
_Inutile de rappeler que la pièce est dans le noir._

-> Perception: pour détecter la goule.

_Si la goule est détectée, le combat peut commencer. La goule est alors sur un des casiers, et les regarde._
...
_Si la goule n'est pas détectée, le combat débutera avec le réveille du contremaitre. Lorsque quelqu'un touchera sa broche, le cadavre tentera de mordre sa cible. La goule attaquera par derrière_

-   _Zombi Mineur_ (FP 1/2) *2
...
-   _1 liche naine (cf [Liche Bzakhudyk](../1-Everton/2-Personnages/Bramnyl_Bzakhudyk.md)) + invocation 6 squelettes_
-   _2 fanatiques_
...
-   Connaissance de la pierre [**DD 10**] : le nain reconnait facilement que cette pierre est façonnée de la même manière que celle trouvée sous Everton.
...
_Le nain reconnait la fresque et il chuchote le nom. Il peut raconter la légende_

Perception [**DD10**]: si le DD est dépassé, les aventuriers entendront les personnes à temps. Leur laissant ainsi les secondes précieuses pour agir. Sinon, les aventurier auront 5 secondes pour agir.
...
Deux fanatique et 3 squelettes feront leur entrée dans le hall, faisant route vers le trou par lequel les aventuriers sont arrivés.
...
La liche soulèvera alors le nain par télékinésie et lui brise la nuque. Le nain tombe inerte au sol. Il est à 0pv.  
La liche se tourne ensuite vers la rôdeuse:
"Je saurais faire de toi quelque chose d'utile"  
Enfin la Liche se dirige vers le mage. Elle passe une main le long de la joue du mage dévoilant ainsi l'illusion et faisant apparaitre un court instant le vrai visage de Silifrey.  
...
-   _Baguette__: morceau de bois sombre tailler en griffe à une extrémité._

-   _Malédiction de la chaire => perd 6 de constitution immédiatement, toutes les heures des pustules de nécrose apparaissent sur la cible, si non soignée dans les 24h transforme la cible en kyste rampant (Libris Mortis 109)._

-   _3000 po_
-   _5 perle noire + 1 diamant + 8 agates_
-   _Un livre, Le journal de Bramnyl_
-   _1 parchemin d'alarme_
-   _1 parchemin d'animation des morts_
